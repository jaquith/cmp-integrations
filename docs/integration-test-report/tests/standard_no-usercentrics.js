...
describe('STEP 1 - initial visit to test page', () => {
  it('should navigate to the page', () => {
    browser.url(helper.standardNoUsercentricsTestPage)
  ...
  it('should NOT have a visible Usercentrics banner', () => {
    const ucBanner = $(helper.selectors.ucShadow)
    chai.expect(ucBanner.isExisting()).to.be.false()
  })
...
describe('STEP 2 - (no Usercentrics, so no consent decision)', () => {
  it('(no tracking to deny)', () => {
